...
const { LandingScreen } = compile("app/landing.tsx", { "@/lib/landing-copy": translations, "@/lib/guide-copy": compile("lib/guide-copy.ts"), "./landing-examples": examples, "./brand-logo": brandLogo });
